  ...
  useEffect(() => {
    if (session?.user) {
      ...
      setFormData({
        ...
        password: '', 
        responsibleCPF: session.user.responsibleCPF || '',
          ...
          <div className="bg-white shadow-lg rounded-lg w-[80%] h-[auto] mt-6">
            ...
            <div className="p-6 grid grid-cols-2 gap-6 items-start">
              <div>
                ...
                <div className="flex flex-col gap-0.5 mb-4">
                  <label className="font-semibold text-gray-600" htmlFor="password">Password:</label>
                  <input
                    id="password"
                    name="password"
                    type="password"
              ...
              <div>
                <div className="flex flex-col gap-0.5 mb-4">
                  <label className="font-semibold text-gray-600" htmlFor="birthday">Birthday:</label>
                  <input
                    id="birthday"
                    name="birthday"
                    type="text"
