...
const ClassCard: React.FC<ClassCardProps> = ({ id, nome, horario, professor, descricao }) => {
  return (
    <Link href={`/turma/${id}`} className='w-[250px] h-[350px] lg:w-[330px] rounded-md md:w-[300px] bg-white p-2 md:p-4 hover:bg-gray-100 border-[1px] flex flex-col justify-between border-blue-700  mt-6 md:mt-0 '>
      <div className=''>
