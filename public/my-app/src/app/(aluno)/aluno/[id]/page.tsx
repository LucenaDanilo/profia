        ...
        <div className='container mx-auto flex justify-center'>
          <div className="bg-white shadow-lg rounded-lg w-[80%] h-[auto] mt-6">
            ...
            <div className='flex justify-between p-6'>
              <div className='flex'>
                <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfaclSlk2r66bbWERGnl22DK3rzT3AKdtdMw&s" 
                
                alt='buba' width={60} height={60} className='rounded-full p-1'/>
