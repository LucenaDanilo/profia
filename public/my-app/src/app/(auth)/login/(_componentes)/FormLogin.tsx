    ...
    <div className='flex flex-col items-center justify-center  px-2 py-4 md:px-6 md:py-12 lg:px-8 text-black'>
      ...
      <div className='mt-4'>
        <form onSubmit={handleLogin} className='space-y-6'>
          ...
          <div>
            <label htmlFor="email" className='block text-sm font-medium leading-4 text-gray-900'>Senha</label>
            <div className='mt-2'>
                <input id="password" name="password" type="password"  required className="block w-full rounded-md border-0 pl-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
